---
title: "Risk of Dengue Transmission in non-endemic area of Mexico using LightGBM (2012-2013)"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Risk of Dengue Transmission in non-endemic area of Mexico using LightGBM (2012-2013)}
...
Predicting the probability of the presence of dengue in non-endemic area of Mexico using LightGBM
...
lgbm_grid <- lgbm_sp |>
    ...
    recipes::update(
        ## 18 columnas sqrt(23) = 4.7 aprox 5, min = 5-3, max = 5+3
        mtry = dials::mtry(range= c(2, 8)),
