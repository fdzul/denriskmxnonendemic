---
title: "Risk of Dengue Transmission in non-endemic area of Mexico using XGBoost (2023-2025)"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Risk of Dengue Transmission in non-endemic area of Mexico using XGBoost (2023-2025)}
...
load("~/Library/CloudStorage/Dropbox/projects/INSP/spatial_temporal_distribution_dengue_mx/8.RData/enm/data_models/dengue_2023_2025_layers_n60000.RData")
data <- data2023_2025$data_lyrs

# Step. extract the area of interes ####

aoi <-  data2023_2025$aoi |>
...
xgb_grid <- xgb_sp |>
    ...
    recipes::update(
        ## 23 columnas sqrt(18) = 4.7 aprox 5, min = 5-2, max = 4 +3
